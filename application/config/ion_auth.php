 ...
 */
$config['site_title']                 = "Aprendiendo a prevenir";       // Site Title, example.com
$config['admin_email']                = "no-reply@aprendiendoaprevenir.com"; // Admin Email, admin@example.com
$config['site_version']                = "2017";        // Version para el registro del juego
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'dni';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
