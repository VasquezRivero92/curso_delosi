    ...
    <body class="<?php echo $avatar . ' ' . $owlgrupo; ?>">
        ...
        <div id="historia" class="resizeWindow">
            ...
            <div id="instruccion_1" class="instrucciones">
                <div id="i1tit_1">NIVEL TRES</div>
                <div id="i1tit_2">PREVENCIÓN</div>
                <div id="i1tit_3">CON INSTRUMENTOS</div>
                <div id="i1tit_4">DE TRABAJO</div>
            </div>
            <!-- - - - - - - - - - - - - -  Instruccion 2  - - - - - - - - - - - - - -->
            <div id="instruccion_2" class="instrucciones">
                <div id="i2img_1"></div>
                <div id="i2tit_1"></div>
                <div id="i2txt_1">Al manipular instrumentos de trabajo pueden provocarnos lesiones, es por esto que para evitar que sucedan debemos prestar mucha atención al realizar nuestras actividades y no improvisar o realizar alguna actividad para la cual no hemos sido entrenados o capacitados.
                    <br>Para hacer más completo tu aprendizaje al final de este nivel pondrás a prueba lo aprendido mediante un DESAFÍO DE PREVENCIÓN.</div>
            ...
            <div id="instruccion_3" class="instrucciones">
                ...
                if ($this->session->win < 2) {
                    ...
                    echo anchor('nivel3/reto', 'Iniciar Reto', array('id' => 'btnJugar'));
                } else {
            ...
            <div id="sliderPage_2" class="instrucciones">
                ...
                <div class="cont-carousel">
                    <div class="owl-carousel">
                        ...
                        <div class="item" data-id=4>
                            <div id="s2i4"></div><div id="s2i4h"></div><div id="s2i4p"></div><div class="itmHand"></div><div class="itemLoader"></div>
                        </div>
                    </div>
                </div>
                <div class="btnVolver"></div>
            ...
            <div id="sliderPage_4" class="instrucciones">
                ...
                <div class="cont-carousel">
                    <div class="owl-carousel">
                        ...
                        <div class="item" data-id=3>
                            <div id="s4i3"></div><div id="s4i3h"></div><div id="s4i3p"></div><div class="itmHand"></div><div class="itemLoader"></div>
                        </div>
                    </div>
                </div>
                <div class="btnVolver"></div>
