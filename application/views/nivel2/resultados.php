    ...
    <body class="<?php echo $avatar . ' ' . $owlgrupo; ?>">
        ...
        <div id="historia" class="resizeWindow">
            ...
            <div id="instruccion_5" class="instrucciones">
                ...
                <div id="i5txt_1">Yo, <span><?php echo strtoupper($apenombres); ?></span>, declaro haber completado el curso de Prevención de caídas de manera satisfactoria y, asimismo, de haber realizado la prueba sobre el curso de Prevención de caídas (reto).</div>
