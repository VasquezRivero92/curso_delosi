    ...
    <body class="player<?php echo $this->session->avatar . ' ' . $owlgrupo; ?>"><!-- la M determinar con php si es mujer o varon  -->
        ...
        <div id="historia" class="resizeWindow">
            ...
            <div id="escenaJuego1" class="game">
                <div class="gameFrame">
                    <div id="gameArea1" class="areaJuego"></div>
                    <div id="Player_1">
                        <div class="sprite"></div><div class="ptje"></div>
                    </div>
                    <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
                    <div id="fondoOPC1" class="fondoOPC">
                        <div id="icoPel_1" class="icoPel animPeople"></div>
                        <div id="icoPel_2" class="icoPel animPeople"></div>
                        <div id="icoPel_3" class="icoPel animPeople"></div>
                        <div id="icoPel_4" class="icoPel animPeople"></div>
                        <div id="icoPel_5" class="icoPel animPeople"></div>
                        <div id="icoPel_6" class="icoPel animPeopleSano"></div>
                        <div id="icoPel_7" class="icoPel animPeopleSano"></div>
                        <div id="icoPel_8" class="icoPel animPeopleSano"></div>

                        <div id="icoPrev_1" class="icoPrev animPeopleSano"></div>
                        <div id="icoPrev_2" class="icoPrev animPeopleSano"></div>
                        <div id="icoPrev_3" class="icoPrev animPeopleSano"></div>
                        <div id="icoPrev_4" class="icoPrev animPeopleSano"></div>
                        <div id="icoPrev_5" class="icoPrev animPeopleSano"></div>
                        ...
                        <div id="powerUp_6" class="powerUp powerUp1">5</div>
                        <div id="powerUp_7" class="powerUp powerUp1">5</div>
                        <div id="powerUp_8" class="powerUp powerUp1">5</div>
                    </div>
                </div>
            </div>
            <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
            ...
            <div id="pregWindow">
                ...
                <div id="pregBien_opcinal" class="caratula">
                    <div id="btnListo_2"></div>
                </div>
            ...
            <div id="capaResumen">
                <div id="caratulaFin1" class="caratula">
                    ...
                    <?php
                        echo anchor('nivel12/certificado_curso', '&nbsp;', array('id' => 'i4Certificado', 'class'=>'disabled', 'target' => '_blank', 'style' => 'left: 874px;
                        top: 474px;'));
                    ?> 
                    <!--  -->
            ...
            <div id="objetosOcultos">
                <img id="fondoStage_1" src="<?php echo base_url($own_dir . '/images/fondos/' . $grupoIMG . '/fondo1.jpg'); ?>" alt=""/>
                <img id="canvasWall_1" src="<?php echo base_url($own_dir . '/images/fondos/' . $grupoIMG . '/fondoC1.png'); ?>" alt=""/>
            </div>
        </div>
        <!-- - - - - - - - - - - - - - - -  Controles  - - - - - - - - - - - - - - - -->
