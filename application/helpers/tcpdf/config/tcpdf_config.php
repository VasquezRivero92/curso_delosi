 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Aprendiendo a prevenir');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Aprendiendo a prevenir");
 ...
 */
define ('PDF_FONT_NAME_MAIN', 'marianina');

/**
 * Default main font size.
 */
define ('PDF_FONT_SIZE_MAIN', 17);
