...
var audios = [
    ['BGresul', bdir + 'assets/sounds/instrucciones.mp3'],
    ['playBTN', bdir + 'assets/sounds/catch.mp3'],
    ['txti4', odir + '/sounds/txti4.mp3'],
    /*['s1i1', odir + '/sounds/sP3i1.mp3'],
    ['s1i2', odir + '/sounds/sO3i2.mp3'],
    ['s1i3', odir + '/sounds/sO3i3.mp3'],
    ['s1i4', odir + '/sounds/sP3i4.mp3'],
    ['s1i5', odir + '/sounds/sO4i1.mp3'],
    ['s1i6', odir + '/sounds/sO4i2.mp3']*/
];
