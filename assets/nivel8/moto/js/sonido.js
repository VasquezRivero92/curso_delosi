...
var audios = [
    ...
    // nuevos aduios para motos
    ['intro', bdir +'assets/sounds/moto/intro.mp3'],
    ['race', bdir +'assets/sounds/moto/racer_au.mp3'],
    ['claxon', bdir +'assets/sounds/moto/claxon.mp3'],
    ['termino_bien', bdir +'assets/sounds/moto/termino_bien.mp3'],
    ['termino_mal', bdir +'assets/sounds/moto/termino_mal.mp3'],
];
try {
