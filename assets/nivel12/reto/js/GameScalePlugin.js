...
// Plugin para reescalar el juego
// Utilizar modo fit
...
var GameScalePlugin = new Phaser.Class({
  ...
  getBounds: function () {
    return this.game.config.parent ? this.game.canvas.parentNode.getBoundingClientRect() : _windowBounds.setSize(_window.innerWidth, _window.innerHeight);
  },
