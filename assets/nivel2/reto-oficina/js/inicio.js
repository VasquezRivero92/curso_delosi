...
var $PowerPR = [];
var $ActPwrUp = 0;
var $Preguntas = [null, 2, 1, 2, 3, 4, 5, 5, 5, 5];
var $slA = [null,
    'Carga de peso <br>sin equilibrio',
    'Sube y baja las <br>escaleras a la carrera',
    'Sosteniéndose de cualquier parte <br>para alcanzar un lugar alto',
    'Objetos innecesarios <br>en el área de tránsito',
    'Acuosidad derramada <br>en el área de tránsito',
    'Colaborador transitando',
    'Colaborador transitando',
    'Colaborador transitando',
    'Colaborador transitando'
];
var $slB = [null,
    'Puedes perder el equilibrio si llevas <br>carga excesiva o de manera indebida.',
    'No corras mientras transites por <br>las escaleras o áreas comunes.',
    'Usa el equipo adecuado para llegar a zonas altas <br>y conserva las de uso común a una altura razonable.',
    'Procura mantener tu área de trabajo limpia <br>y libre de equipos que comprometan el libre tránsito.',
    'En la medida de tu posibilidad, seca el exceso de <br>líquidos en el piso o da aviso al personal correspondiente.'
];
...
function initBotones() {
    ...
    $('.pregOpc').click(function () {
        ...
        if ($ActPwrUp >= 6 && idResp === $Preguntas[$ActPwrUp]) {
            ...
            $('#spPel_' + $ActPwrUp).hide();
            $('#icoPrev_' + $ActPwrUp).show();
            $('#spPrev_' + $ActPwrUp).show();
            aumentaPtos1();
            $("#pregBien").stop().delay(300).fadeIn(300);
            setTimeout(function () {
                $('#bienSlide_' + $ActPwrUp + ' .bSlideB').html($slB[$ActPwrUp]).addClass("animated bounceInUp").show();
            }, 500);
        } else {
...
function muestraPregunta() {
    ...
    $(".caratula").stop().fadeOut(10);
    $(".pregVista").hide();
    $(".bienSlider div").removeClass("animated bounceInUp").hide();
