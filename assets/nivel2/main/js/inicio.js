...
function showInicio() {
    ...
    if (grup == 'O') {
        $('#i3btn_1').css('left', '167px');
        $('#i3btn_2').css('left', '375px');
        $('#i3btn_3').css('left', '584px');
        $('#i3btn_4').css('left', '792px');
        $('#i3btn_5').hide();
        $('#i3btn_6').css('left', '1003px');
        sClick[5] = [true, 1, 1];
    } else {
        $('#i3btn_1').css('left', '53px');
        $('#i3btn_2').css('left', '262px');
        $('#i3btn_3').css('left', '471px');
        $('#i3btn_4').css('left', '678px');
        $('#i3btn_5').show().css('left', '889px');
        $('#i3btn_6').css('left', '1102px');
    }
}
